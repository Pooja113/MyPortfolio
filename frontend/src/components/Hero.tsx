    ...
    <div className=" border-b border-neutral-900 pb-4 lg:mb-35">
      <div className="flex flex-wrap">
        <div className="w-full lg:w-1/2">
          ...
          <motion.p variants={container(1)} initial="hidden" animate="visible" className="my-2 max-w-xl py-6 font-light tracking-tight"> Over the past three years as a web developer, including 1.5 years specializing as a MERN stack developer, I have honed my skills in a diverse range of technologies and frameworks.I am proficient in JavaScript, TypeScript, and PHP, with extensive experience using frameworks and libraries such as React.js, Next.js, Express.js, Redux, and Tailwind. My expertise extends to both front-end and back-end development, allowing me to build seamless, high-performance applications.</motion.p>
...
<p className="max-w-xl font-light tracking-tight">I am well-versed in working with databases like MongoDB, PostgreSQL, and MySQL, and I leverage tools and technologies such as Docker, Git, and Jenkins to streamline development and deployment processes. My experience with microservices and real-time technologies like SocketIO further enhances my ability to create scalable and dynamic solutions.</p>
        ...
        <div className='w-full lg:w-1/2 p-8'>
            <div className='flex justify-center'>
              <motion.img initial={{x:100, opacity:0}} animate={{x:0, opacity:1}} transition={{duration:1, delay:1.2}} src={profilePic} alt="Pooja Paul" />
          </div></div>
      </div>
    </div>
  )
